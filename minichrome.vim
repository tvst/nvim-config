...
" Fold {{{1
hi! Folded       gui=bold guifg=#8a8a8a guibg=NONE cterm=bold ctermfg=245 ctermbg=NONE
...
" Diff {{{1
hi! DiffAdd      gui=NONE guifg=#dfff00 guibg=#005f00 cterm=NONE ctermfg=190 ctermbg=22
hi! DiffDelete   gui=NONE guifg=#ff8700 guibg=#5f0000 cterm=NONE ctermfg=208 ctermbg=52
hi! DiffText     gui=NONE guifg=#dfff00 guibg=#005f00 cterm=NONE ctermfg=190 ctermbg=22
...
" 
hi! FloatWithBg   gui=NONE guifg=#e4e4e4 guibg=#1c1c1c cterm=NONE ctermfg=254 ctermbg=234
...
" Indent blankline plugin {{{1
hi! link IblScope TabLineSel
